...
def exportar_resultado_pdf(request, resultado_id):
    ...
    html = render_to_string('templates/management_test/resultado_pdf.html', {'resultado': resultado})

    # Cambia esta ruta por donde instalaste wkhtmltopdf
    ...
    pdfkit.from_string(html, output_path=response, configuration=config)
    return response

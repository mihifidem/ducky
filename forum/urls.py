...
urlpatterns = [
    ...
    path('pregunta/<int:pk>/edit/', views.PreguntaUpdateView.as_view(), name='pregunta_edit'),
    ...
    path('respuesta/<int:pk>/edit/', views.RespuestaUpdateView.as_view(), name='respuesta_edit'),
